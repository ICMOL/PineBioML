...
class Volcano_selection(base_selection):
    def __init__(self, plotting = False, strategy = "fold", p_threshold = 0.05, fc_threshold = 2, center = True, scale = False, log_domain = True):
        super().__init__(center = False, scale = False, log_domain = True)
